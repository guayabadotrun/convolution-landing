    ...
    return (
        <section className="bg-white">
            <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                <h1 className="mb-4 text-4xl sm:text-5xl font-anek-latin font-bold tracking-tight leading-none max-w-2xl mx-auto">
                    <span className="whitespace-nowrap">Your <span className="painted">AI Influencer</span></span>
                    <br />
                    toolkit on{' '}
                    <svg
                        role="img"
