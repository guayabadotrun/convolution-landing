            ...
            <div className="container mx-auto mb-14">
                <div className="flex flex-col md:flex-row w-full gap-3">
                    <div className="flex flex-col gap-3 md:w-[60%] min-h-[200px] flex-grow">
                        <div className="p-10 bg-gray-200 border rounded-lg flex flex-col md:flex-row items-center md:gap-0 gap-4 justify-between">
                            <div className='flex flex-row gap-4'>
                                <Github></Github>
                                <p>Explore our Code on GitHub</p>
                            </div>
                            <Button variant='dark' href='#' onClick={() => console.log('click')}>Visit our GitHub</Button>
                        </div>
                        <div className="p-10 bg-gray-200 border rounded-lg h-full flex flex-col justify-center">
                            <h3 className='md:text-4xl text-lg font-light'>We believe in open source.</h3>
                            <p className='md:text-base text-xs my-8'>
                    ...
                    <div className="flex flex-col md:w-[40%] min-h-[200px] flex-grow">
                        <div className="p-10 bg-gray-200 border rounded-lg relative h-full flex flex-col justify-between">
                            <h3 className='md:text-4xl text-lg font-light'>Join the Future of AI Influencers</h3>
                            <div>
                                <p className='md:text-base text-xs mb-8'>
